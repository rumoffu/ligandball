...
public class AccuracyEvaluator {
	...
	public double evaluateWriteAccuracy(List<Instance> instances, Predictor predictor, PredictionsWriter writer) throws IOException {
		int numTested = 0;
		int numCorrect = 0;
		Label prediction;
...
//				System.out.println(prediction.toString());
	...
	public double evaluateWritePR(List<Instance> instances, Predictor predictor, PredictionsWriter writer) throws IOException{
		int numTested = 0;
		int numCorrect = 0;
