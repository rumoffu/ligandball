...
The accuracy, precision, recall, and run time in milliseconds for the $\epsilon$-sphere nearest neighbor algorithm is shown below for when all features are used. \\
